...
public class LatinIME extends InputMethodService implements
    ...
    public android.webkit.WebView getFocusedWebView() {
        if (mActiveDialog != null && mActiveDialog.isShowing()) {
            android.view.View focused = mActiveDialog.getCurrentFocus();
            if (focused instanceof android.webkit.WebView) {
                return (android.webkit.WebView) focused;
            }
        }
        return null;
    }
    ...
    public void hideWindow() {
        ...
        // Don't dismiss mActiveDialog here, as some tools (like browser) should stay open
        // or handle their own dismissal. Attached dialogs will hide automatically with the window.
        super.hideWindow();
    }
    ...
    public void showAiActionsModelDialog() {
        AudioAndHapticFeedbackManager.getInstance().vibrate(20);
        helium314.keyboard.latin.ai.AiDialogComponentsKt.showAiActionsModelDialog(this);
    }
    ...
    public void showBrowserTool() {
        AudioAndHapticFeedbackManager.getInstance().vibrate(20);
        BrowserToolKt.showBrowserTool(this);
    }

    public void showFloatingNoteTool() {
        AudioAndHapticFeedbackManager.getInstance().vibrate(20);
        helium314.keyboard.latin.ai.AiDialogComponentsKt.showFloatingNoteConfigDialog(this);
    }
