...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_AI_ASK_ATTACH_LATEST_IMAGE = "ai_ask_attach_latest_image";
    ...
    public static final String PREF_AI_ALWAYS_SHOW_GALLERY_PROMPT = "ai_always_show_gallery_prompt";
